...
def new_game():
    ...
    my_tiles = [Tile(tile_numbers[i], False, [TILE_WIDTH * (i // LENGTH), TILE_HEIGHT* (1 + i % LENGTH)]) for i in range(2 * DISTINCT_TILES)]
...
frame = simplegui.create_frame("Memory", 2 * DISTINCT_TILES * TILE_WIDTH / LENGTH, TILE_HEIGHT * LENGTH)
