...
class RectangularRoom(object):
    ...
    def isTileCleaned(self, m, n):
        ...
        """
        return self.tiles[int(math.floor(m)), int(math.floor(n))]
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        been cleaned.
        """
        self.temp = self.position.getNewPosition(self.direction, self.speed)
        if self.room.isPositionInRoom(self.temp):
...
#print  runSimulation(10, 1.0, 80, 80, 1.0, 1, StandardRobot)
...
class FixedRobot(Robot):
    """
    A FixedRobot turned a fixed angle when it face the wall.
    """
    def updatePositionAndClean(self):
        self.temp = self.position.getNewPosition(self.direction, self.speed)
        if self.room.isPositionInRoom(self.temp):
...
#print  runSimulation(1, 1.0, 10, 10, 0.8, 3, FixedRobot)
'''
