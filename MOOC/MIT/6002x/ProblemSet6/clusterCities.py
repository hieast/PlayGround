...
class Cluster(object):
    ...
    def singleLinkageDist(self, other):
        ...
        for point1 in self.points:
            for point2 in other.points:
                ...
                if min_dist == None or temp < min_dist:
                    min_dist = temp
        return min_dist
    def maxLinkageDist(self, other):
        ...
        for point1 in self.points:
            for point2 in other.points:
                temp = point1.distance(point2)
                if max_dist == None or temp > max_dist:
                    max_dist = temp
        return max_dist
...
class ClusterSet(object):
    ...
    def mergeClusters(self, c1, c2):
        ...
        self.members.append(Cluster(c1.points + c2.points, c1.pointType))
    ...
    def findClosest(self, linkage):
        ...
        for c1 in self.members:
            for c2 in self.members:
                if self.members.index(c1) < self.members.index(c2):
                    if min_num == None or linkage(c1, c2) < min_num:
                        min_num = linkage(c1, c2)
                        res1 = c1
                        res2 = c2
        return res1, res2
